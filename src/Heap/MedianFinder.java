...
public class MedianFinder {
    // Max heap for the first half of the increasing ordered list and
    // Min heap for the second half of the second half of the increasing ordered list
    ...
    public void addNum(int num) {
        // First add the number to the max heap and then add the topmost i.e., the greatest of the first half to the min heap
        maxHeap.add(num);
        minHeap.add(maxHeap.poll());

        // This condition is true when number of elements are odd. We intend to make the size of the max heap more than that of the min heap
        // Because if the num of elements are odd then the top most of max heap is the answer
